...
the `mkpandocs.yml` configuration file.
...
The [nav](configuration.md#nav) configuration setting in your `mkpandocs.yml` file
...
can set in your `mkpandocs.yml` configuration file to alter the default behavior:
